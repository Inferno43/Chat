...
public class SharedPref {
    ...
    public static final String PREFS_OFSCHAT = "OFSChat";
    public static final String PREFS_USEREMAIL= "email";
    ...
    public void init(Context context) {
        ...
        settings = context.getSharedPreferences(PREFS_OFSCHAT, Context.MODE_PRIVATE); //1
    ...
    public void save(Context context, HashMap<String,?> map) {
        ...
        if(map.containsKey(PREFS_USEREMAIL))
            editor.putString(PREFS_USEREMAIL,String.valueOf(map.get(PREFS_USEREMAIL)));
    ...
    public String getString(Context context,String PREFS_KEY) {
        ...
        //settings = PreferenceManager.getDefaultSharedPreferences(context);
        settings = context.getSharedPreferences(PREFS_OFSCHAT, Context.MODE_PRIVATE);
